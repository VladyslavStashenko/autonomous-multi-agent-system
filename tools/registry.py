...
TOOL_SCHEMAS = {
    ...
    "create_directory": types.Schema(
        type="OBJECT",
        properties={
            "path": types.Schema(type="STRING", description="Relative directory path to create inside the project."),
        },
        required=["path"],
    ),
    ...
    "delete_file": types.Schema(
        type="OBJECT",
        properties={
            "path": types.Schema(type="STRING", description="Relative file path inside the project to delete."),
        },
        required=["path"],
    ),
...
def get_available_tools_description() -> str:
    return "\n".join(
        [
            ...
            "- create_directory(path): Create a directory inside the project.",
            ...
            "- delete_file(path): Delete a file inside the project.",
